...
func TestAll(t *testing.T) {
	...
	b.Add("7")
	b.Add("8")
	scratch := make([]string, 8)
	assert.Equal(t, []string{"1", "2", "3", "4", "5", "6", "7", "8"}, b.All(&scratch))
	b.Add("9")
	assert.Equal(t, []string{"9"}, b.All(&scratch))
	assert.Equal(t, []string{}, b.All(&scratch))
	b.Close()
	assert.Nil(t, b.All(&scratch))
}
